...
export default class FAQPage extends React.Component {
    ...
    render () {
      return(
        <Layout>
          <div>
            <img src="/bipphoto.jpg"  width="624" height="666" className = {styles.image}></img>
              ...
              <Link href = "https://bit.ly/hcs-bip-app"><button className = {styles.expandcollapse}>Apply Now</button></Link>
          </div>
        </Layout>
      );
    }
