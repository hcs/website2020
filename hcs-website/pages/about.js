...
export default class About extends React.Component {
  constructor(props) {
    ...
    this.projects = [
      ...
      {
        title: "Other Projects", body: <p className={styles.container}> We work closely with various organizations at Harvard to promote the visible use of advanced technology. Some of our more important collaborative projects {' '}
