...
export default class FAQPage extends React.Component {
    constructor(props) {
      ...
      this.general = [
          ...
          {title: "What is the history of HCS?", body: "The history of HCS dated back to 1983, making it older than most of our current members. HCS was founded to publish the Harvard Computer Review and Computing@Harvard. Fun fact: 2020 is the 20th anniversary of our mailing list service."},
          ...
          {title: "How can I donate money or computer hardware to support HCS?", body: "You can email HCS board! We appreciate your donation to support our various projects and our core mission. We can arrange for the donation to be tax-deductible, but please let us know in advance so we can channel it through the University."},
      ...
      this.involved = [
          ...
          {title: "How can I join HCS?", body: "HCS runs an educational bootcamp series offered in both the fall and the spring. The bootcamps cover various topics including data mining, APIs, web scraping, and web development. It is a great way to hone your skills, make new friends, and connect with our industry sponsors! Due to the current Covid-19 crisis, only 2 bootcamps are needed to become a member of HCS."},
          {title: "How can I stay updated with HCS information?", body: "Join HCS Slack to get updated information about announcements, community events, internships, and job opportunities. Additionally, you can click on the link below to subscribe to HCS’ own mailing lists."}
